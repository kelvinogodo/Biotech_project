        ...
        <div className='landpage-content-wrapper'>
            ...
            >
                ...
                >
                    ...
                    <span className='emphasy'>Biomedical Engineering®</span>
                </motion.h1>
                <motion.p
                    initial={{x:-65, opacity:0}}
                    animate={{x:0, opacity:1}}
                ...
                >
                     The Nigerian Institute for Biomedical Engineering, NIBE is a non-governmental organisation representing the biomedical engineering and technology profession and its members in Nigeria...
                </motion.p>
